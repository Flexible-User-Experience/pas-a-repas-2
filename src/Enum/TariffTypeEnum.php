...
class TariffTypeEnum
{
    ...
    public const TARIFF_FAMILIY_PRIVATE_LESSON_PER_HOUR = 13;
    public const TARIFF_FAMILIY_SHARED_PRIVATE_LESSON_PER_HOUR = 14;
    public const TARIFF_PRIVATE_LESSON_PER_HOUR_AND_A_HALF = 15;
